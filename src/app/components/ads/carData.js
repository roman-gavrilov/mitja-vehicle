...
export const carModels = {
  ...
  "bmw": ["1 Series", "2 Series", "3 Series", "4 Series", "5 Series", "7 Series", "X1", "X3", "X5", "Z4"],
  ...
  "hummer": ["H1", "H2", "H3", "EV"],
  "hyundai": ["Elantra", "Santa Fe", "Sonata", "Tucson", "Kona"],
  "infiniti": ["Q50", "Q60", "QX50", "QX80"],
  "isuzu": ["D-Max", "MU-X", "Rodeo"],
  "jaguar": ["XE", "XF", "F-Type", "F-Pace", "I-Pace"],
  "jeep": ["Cherokee", "Wrangler", "Compass", "Grand Cherokee", "Renegade"],
  ...
  "mercedes-benz": ["A-Class", "C-Class", "E-Class", "S-Class", "GLE", "GLC", "G-Class"],
